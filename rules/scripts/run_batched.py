#!/usr/bin/env python3
"""
Run the ATAC-seq pipeline in sequential sample batches for very low-resource machines.
...
def main():
    parser = argparse.ArgumentParser(description="Run ATAC-seq pipeline in sample batches")
    ...
    print("\nRunning final aggregation (MultiQC)...")
    final_cmd = [
        "snakemake",
        "--use-conda",
        "--conda-frontend", "mamba",
