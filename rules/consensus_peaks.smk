rule consensus_peaks:
    ...
    shell:
        ...
        rm -f {output.consensus}.merged.tmp {output.consensus}.candidate.bed {output.consensus}.overlaps.tmp || (echo "Graceful degradation fallback triggered"; touch {output}; true)
        """
