rule preseq:
    ...
    conda: "envs/04_metrics_qc/preseq.yaml" if config.get("use_conda", True) else None
    container: "docker://quay.io/biocontainers/preseq:3.2.0--hdcf5f25_6" if config.get("use_container", True) else None
